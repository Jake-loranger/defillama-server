...
const data4: Protocol[] = [
  ...
  */
  ...
  },
  {
    ...
    description: "Alpha Arcade is a decentralized prediction marketplace built on the Algorand blockchain, enabling users to speculate on outcomes across sports, geopolitics, crypto, business, and more.",
    chain: "Algorand",
    logo: `${baseIconsUrl}/alphaarcade-logo.png`,
    audits: null,
    audit_note: null,
    gecko_id: null,
    cmcId: null,
